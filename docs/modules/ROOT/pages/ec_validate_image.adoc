...
--comprehensive-filter:: Enable the new comprehensive post-evaluation filtering system. This provides more
detailed filtering capabilities but may change the behavior of rule inclusion/exclusion.
Use with caution in production environments. (Default: true)
