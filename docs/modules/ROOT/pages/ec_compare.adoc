...
Compare two Enterprise Contract Policy specs for equivalence

== Synopsis

Compare two Enterprise Contract Policy specs to determine if they would
...
--effective-time:: Effective time for policy evaluation (RFC3339 format, 'now', or 'attestation') (Default: now)
