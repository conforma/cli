...
require (
	...
	github.com/conforma/crds/api v0.1.3
	...
	github.com/testcontainers/testcontainers-go v0.39.0 // using unreleased version that contains the fix in https://github.com/testcontainers/testcontainers-go/pull/2899
...
// LLM_UPGRADER_PROTECTION: preserve_manual_directives

// Pin tablewriter to compatible version due to API breaking changes
