...
require (
	...
	github.com/konflux-ci/application-api v0.0.0-20260130153254-5b537be3e11b
	...
	github.com/testcontainers/testcontainers-go v0.40.0 // using unreleased version that contains the fix in https://github.com/testcontainers/testcontainers-go/pull/2899
	github.com/testcontainers/testcontainers-go/modules/registry v0.40.0
	golang.org/x/benchmarks v0.0.0-20260112172216-6f24f8f3cdca
