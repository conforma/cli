...
require (
	...
	github.com/testcontainers/testcontainers-go v0.38.0 // using unreleased version that contains the fix in https://github.com/testcontainers/testcontainers-go/pull/2899
	github.com/testcontainers/testcontainers-go/modules/registry v0.38.0
	golang.org/x/benchmarks v0.0.0-20250813145245-f5a05f6f06c5
